package com.zsoltbertalan.signalstrength.design
...
val SignalStrengthLightColorScheme = lightColorScheme(
...
private val SignalStrengthDarkColorScheme = darkColorScheme(
...
private val LocalAppColors = staticCompositionLocalOf {
	SignalStrengthLightColorScheme
}
...
fun SignalStrengthTheme(
	...
	val colorScheme = when {
		...
		isDarkTheme -> SignalStrengthDarkColorScheme
		else -> SignalStrengthLightColorScheme
	}
	...
	ProvideDimens(dimensions = dimensions) {
		ProvideColors(colorScheme = colorScheme) {
			MaterialTheme(
				colorScheme = colorScheme,
				typography = SignalStrengthTypography,
				content = content
			)
		}
	}
...
val Dimens: Dimensions
	@Composable
	get() = SignalStrengthTheme.dimens

val Colors: ColorScheme
	@Composable
	get() = SignalStrengthTheme.colorScheme
